...
import { definePlugin, type ExtractExtensions } from "./v2";

// Helper type to check if a type is `any`
type IsAny<T> = 0 extends 1 & T ? true : false;

// ============================================
// createStoreVariadic - the new store signature
// ============================================
...
test("definePlugin validates plugin shape", () => {
  ...
  const withMiddleware = definePlugin(<TState>(store: StoreApi<TState>) => ({
    id: "middleware",
