 ...
 */
export async function UserProfileModal({ userId }: { userId: string }) {
 ...
 */
export async function InvoiceModal({ invoiceId }: { invoiceId: string }) {
 ...
 */
export async function DashboardModal({ userId }: { userId: string }) {
  // This returns immediately, inner components stream in
  return (
    <div className="space-y-4">
...
// Async server components that stream in
